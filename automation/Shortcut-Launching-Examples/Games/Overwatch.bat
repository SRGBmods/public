...
:APPLYLAYOUT
REM -------------------------------------------------------------------------------------
REM You will need to set the layout you have created for Overwatch (Or a generic Game layout)
REM -------------------------------------------------------------------------------------
REM
REM Remember %%20 = a space
REM Edit the next line for your layout:
explorer "signalrgb://layout/apply/Overwatch?-silentlaunch-"
...
:GAMELAUNCH
timeout 2 > nul 2> nul
explorer "signalrgb://effect/apply/Overwatch?-silentlaunch-"
explorer battlenet://Pro
goto exitcheck

:exitcheck
timeout 20 > nul 2> nul
tasklist /fi "imagename eq Overwatch.exe"|find /i "=========================" >nul 2>nul &&(
