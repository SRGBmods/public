...
:APPLYLAYOUT
REM -------------------------------------------------------------------------------------
REM You will need to set the layout you have created for Path of Exile (Or a generic Game layout)
REM -------------------------------------------------------------------------------------
REM
REM Remember %%20 = a space
REM Edit the next line for your layout:
explorer "signalrgb://layout/apply/Path%%20of%%20Exile?-silentlaunch-"
...
:GAMELAUNCH
timeout 2 > nul 2> nul
explorer "signalrgb://effect/apply/Path%%20of%%20Exile?-silentlaunch-"
explorer steam://run/238960
