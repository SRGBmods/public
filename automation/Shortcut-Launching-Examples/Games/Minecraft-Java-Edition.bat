...
start /D %%appdata%%\.minecraft\bin %%JAVAW_PATH%%\javaw -Xms512m -Xmx1g -Djava.library.path=natives/ -cp "minecraft.jar;lwjgl.jar;lwjgl_util.jar" net.minecraft.client.Minecraft
goto exitcheck
