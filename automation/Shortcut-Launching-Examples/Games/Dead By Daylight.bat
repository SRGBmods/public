...
:GAMELAUNCH
REM -------------------------------------------------------------------------------------
REM You will need to set the layout you have created for Dead By Daylight (Or a generic Game layout)
REM -------------------------------------------------------------------------------------

explorer "signalrgb://layout/apply/Dead%%20By%%20Daylight?-silentlaunch-"
...
REM
timeout 2 > nul 2> nul
explorer "signalrgb://effect/apply/Dead%%By%%20Daylight?-silentlaunch-"
explorer steam://run/381210
